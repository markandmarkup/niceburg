    ...
    if (checkNewReviewKeys($new_review)) {
        ...
        if (strlen(implode($errors)) == 0) {
            if (addNewReview($db, $new_review)) {
                $user_message  = 'Review successfully posted!';
            } else {
...
<div class="content-column">
    ...
    <section class="review-form">
        ...
        <form action="add-review.php" method="post">
            ...
            <div class="form-line short-form-line">
                <label for="price">Price</label><span>&#163;</span><input id="price" class="short-input" name="price" type="number" step="0.01" min="0" max="999.99"  value="<?= isset($currentReview['price']) ? $currentReview['price'] : ''; ?>" required />
            </div>
